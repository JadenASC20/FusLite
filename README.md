...
A physically based real-time renderer built from scratch in **Vulkan 1.3**, with no engine or rendering framework underneath. FusLite implements a modern forward+ rendering pipeline: PBR, image based lighting, clustered light culling, cascaded shadows, and temporal antialiasing.
