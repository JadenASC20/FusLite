...
static bool g_taaResolveEnabled = true;      // TAA: master toggle for the resolve blend
    ...
    ImGuiManager& imguiManager, bool showGui, RenderParams params)
{
    ...
    // tonemap pass keeps reading HDR. See RecordFrame doc in main().
    // ========================================================================
...
int main() {
    ...
    try {
        ...
        // --- TAA resolve pipeline (reuses the same fullscreen triangle vertex shader) ---
        ...
        while (!glfwWindowShouldClose(window)) {
            ...
            // TAA history parity: snapshot BEFORE the ++ so read/write are stable & distinct.
            ...
            RecordFrame(commandBuffers[imageIndex], imageIndex, swapchain, renderPass,
                ...
                shadowMap, shadowPipeline, lightViewProj,
